...
///
/// ```text
///                                        value          raw bytes (= value·R mod p)
///   lhs = from_raw(a)        feed a in as raw limbs:   a · R⁻¹        a
///   rhs = from_bytes_le(b)   canonical -> Felt:        b              b · R          (1 Montgomery mul)
///   product = lhs * rhs                                a · b · R⁻¹    a · b          (1 Montgomery mul)
///   dst = to_raw(product)    read raw limbs out:       —              a · b  (the canonical product)
/// ```
